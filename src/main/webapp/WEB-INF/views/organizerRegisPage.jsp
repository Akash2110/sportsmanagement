...
<script type="text/javascript">
	...
	function validatingForm() {
		...
		if (document.form.organizerId.value == "") {
			alert("Please update the highlighted field");
			document.loginform.organizerId.focus();
			return false;
		}
...
<body>
	...
	<%
		...
		if (fail != null && fail.length() != 0)
			out.println(" <center><h3><div  style='margin-top:50px;' id='fadeout'>" + fail + "</div></h3></center> ");
	%>
	...
	<div class="signup-form">
		<form:form name="form" action="organizerRegisterUser" method="post"
			...
			<h2>Organizer Registration</h2>
					...
					<form:errors path="organizerId" class="error"></form:errors>
